...
- (void)drawInContext:(CGContextRef)context
{
	...
	CGContextSetShadowWithColor(context, CGSizeMake(0.0, 1), 2.0, [UIColor blackColor].CGColor);
	CGContextSetLineWidth(context, 0.5);
	UIBezierPath *outlinePath = [UIBezierPath bezierPathWithRoundedRect:CGRectOffset(self.bounds, 0.0, 0.0) cornerRadius:self.bounds.size.height / 2.0];
    ...
    CGContextSetStrokeColorWithColor(context, [UIColor colorWithRed:64./255. green:64./255. blue:64./255. alpha:1.0].CGColor);
